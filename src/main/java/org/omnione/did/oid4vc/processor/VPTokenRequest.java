package org.omnione.did.oid4vc.processor;
...
/**
 * DTO containing VP Token generation request information
 *
...
public class VPTokenRequest {
  ...
  /** Credential data (SD-JWT string, JsonNode, JWT, etc.) */
