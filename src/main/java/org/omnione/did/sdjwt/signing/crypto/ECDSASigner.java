package org.omnione.did.sdjwt.signing.crypto;
...
public class ECDSASigner implements JWSSigner {
    ...
    private byte[] signWithWalletManager(String signingInput) throws Exception {
        try {
            ...
            log.info("First 10 bytes: {}", java.util.Arrays.toString(java.util.Arrays.copyOf(signature, Math.min(10, signature.length))));
